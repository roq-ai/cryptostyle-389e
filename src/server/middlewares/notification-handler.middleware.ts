...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'customer.create': {
    roles: ['owner', 'administrator', 'finance-manager', 'customer-service-representative'],
    key: 'customer-account-created',
    tenantPath: ['organization', 'user', 'customer'],
    userPath: [],
  },
  'customer.delete': {
    roles: ['owner', 'administrator', 'finance-manager', 'customer-service-representative'],
  ...
  'prepaid_card.update': {
    roles: ['owner', 'administrator', 'finance-manager', 'customer-service-representative'],
    key: 'prepaid-card-funded',
    tenantPath: ['organization', 'user', 'customer', 'prepaid_card'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'administrator', 'finance-manager', 'customer-service-representative'];
