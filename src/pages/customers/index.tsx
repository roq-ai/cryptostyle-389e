...
export function CustomerListPage(props: CustomerListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('prepaid_card', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'prepaid_card',
          header: 'Prepaid Card',
          accessorKey: 'prepaid_card',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/prepaid-cards/view/${record.prepaid_card?.id}`}
            >
              {record.prepaid_card?.currency}
            </Link>
          ),
        }
      : null,
