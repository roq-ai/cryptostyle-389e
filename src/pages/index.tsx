...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`CryptoStyle`}</title>

        <meta
          name="description"
          content="Experience seamless cryptocurrency exchange with CryptoStyle - Fund your prepaid card using your tatum.io x-api-key and ledger account id, your gateway to financial freedom."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1518546305927-5a555bb7020d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjcnlwdG9jdXJyZW5jeXxlbnwwfHx8fDE2OTM1OTIyNDl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless cryptocurrency exchange with CryptoStyle - Fund your prepaid card using your tatum.io x-api-key and ledger account id, your gateway to financial freedom.`}
            </Text>
            <Box
